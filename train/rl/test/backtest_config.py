...
OPEN_PROB_THRESHOLD = _env_float("OPEN_PROB_THRESHOLD", 0.93)
OPEN_EDGE_THRESHOLD = _env_float("OPEN_EDGE_THRESHOLD", 0.24)
MIN_ACTION_MARGIN = _env_float("MIN_ACTION_MARGIN", 0.24)
HOLD_EDGE_THRESHOLD = _env_float("HOLD_EDGE_THRESHOLD", 0.10)
TRADE_COOLDOWN_BARS = _env_int("TRADE_COOLDOWN_BARS", 4)
...
DEF_CONF_BONUS = _env_float("DEF_CONF_BONUS", 0.08)
...
COUNTER_TREND_CONF_BONUS = _env_float("COUNTER_TREND_CONF_BONUS", 0.05)
