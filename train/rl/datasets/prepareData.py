...
ohlc_end   = datetime(2026, 2, 27, 23, 59, 59, tzinfo=timezone)
...
def fetch_delta_from_ticks(mt5, symbol, start, end, resample_rule):
    ...
    print(f"    ส่วนนี้อาจใช้เวลานานมาก เนื่องจากต้องโหลด tick data รายวัน\n")
...
print(f"⏱  ประมาณ {(tick_end - tick_start).days} วัน")
print("  อาจใช้เวลานานมาก! กรุณารอ...")
