  ...
  const onSubmit = async (data: AuthFormData) => {
    ...
    try {
      ...
      if (error) {
        ...
        } else if (error.message.includes("Please login with Google")) {
          toast.error("This account uses Google login. Please use 'Continue with Google'");
        } else {
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="bg-card rounded-2xl shadow-lg p-8 border border-border">
            <h2 className="text-2xl font-semibold text-center text-muted-foreground mb-6">
              Sign In
            </h2>
