...
def build_bot_runtime_env(
    *,
    ...
    optional_passthrough = {
        ...
        "BOT_RUNNER_INTRABAR_TAKE_PROFIT_CHANGE_PCT": "LIVE_INTRABAR_TAKE_PROFIT_CHANGE_PCT",
        "BOT_RUNNER_INTRABAR_TAKE_PROFIT_PIPS": "LIVE_INTRABAR_TAKE_PROFIT_PIPS",
        "BOT_RUNNER_INTRABAR_TAKE_PROFIT_MONEY": "LIVE_INTRABAR_TAKE_PROFIT_MONEY",
        "BOT_RUNNER_INTRABAR_TRAILING_ENABLED": "LIVE_INTRABAR_TRAILING_ENABLED",
        "BOT_RUNNER_INTRABAR_TRAIL_KEEP_RATIO_TREND": "LIVE_INTRABAR_TRAIL_KEEP_RATIO_TREND",
        "BOT_RUNNER_INTRABAR_TRAIL_KEEP_RATIO_NORMAL": "LIVE_INTRABAR_TRAIL_KEEP_RATIO_NORMAL",
        "BOT_RUNNER_INTRABAR_TRAIL_KEEP_RATIO_TIGHT": "LIVE_INTRABAR_TRAIL_KEEP_RATIO_TIGHT",
        "BOT_RUNNER_INTRABAR_TRAIL_ARM_BUFFER_RATIO": "LIVE_INTRABAR_TRAIL_ARM_BUFFER_RATIO",
        "BOT_RUNNER_INTRABAR_TRAIL_CONFIRM_POLLS": "LIVE_INTRABAR_TRAIL_CONFIRM_POLLS",
        "BOT_RUNNER_INTRABAR_MIN_BAR_AGE_SEC": "LIVE_INTRABAR_MIN_BAR_AGE_SEC",
        "BOT_RUNNER_INTRABAR_DISABLE_LAST_SEC": "LIVE_INTRABAR_DISABLE_LAST_SEC",
    ...
    if isinstance(trading_schedule, str):
        schedule_json = str(trading_schedule).strip()
    elif trading_schedule is not None:
        try:
            schedule_json = json.dumps(trading_schedule, ensure_ascii=True, separators=(",", ":"))
        except Exception:
            schedule_json = ""
    if schedule_json:
        env["LIVE_TRADING_SCHEDULE_JSON"] = schedule_json
