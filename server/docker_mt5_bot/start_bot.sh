...
METATRADER_IMAGE="${METATRADER_IMAGE:-smarfrobot_mt5}"
...
LIVE_INTRABAR_TAKE_PROFIT_PIPS_VAL="${LIVE_INTRABAR_TAKE_PROFIT_PIPS:-$(read_dotenv_value LIVE_INTRABAR_TAKE_PROFIT_PIPS)}"
LIVE_INTRABAR_TAKE_PROFIT_MONEY_VAL="${LIVE_INTRABAR_TAKE_PROFIT_MONEY:-$(read_dotenv_value LIVE_INTRABAR_TAKE_PROFIT_MONEY)}"
LIVE_INTRABAR_TAKE_PROFIT_CHANGE_PCT_VAL="${LIVE_INTRABAR_TAKE_PROFIT_CHANGE_PCT:-$(read_dotenv_value LIVE_INTRABAR_TAKE_PROFIT_CHANGE_PCT)}"
LIVE_INTRABAR_TRAILING_ENABLED_VAL="${LIVE_INTRABAR_TRAILING_ENABLED:-$(read_dotenv_value LIVE_INTRABAR_TRAILING_ENABLED)}"
LIVE_INTRABAR_TRAIL_KEEP_RATIO_TREND_VAL="${LIVE_INTRABAR_TRAIL_KEEP_RATIO_TREND:-$(read_dotenv_value LIVE_INTRABAR_TRAIL_KEEP_RATIO_TREND)}"
LIVE_INTRABAR_TRAIL_KEEP_RATIO_NORMAL_VAL="${LIVE_INTRABAR_TRAIL_KEEP_RATIO_NORMAL:-$(read_dotenv_value LIVE_INTRABAR_TRAIL_KEEP_RATIO_NORMAL)}"
LIVE_INTRABAR_TRAIL_KEEP_RATIO_TIGHT_VAL="${LIVE_INTRABAR_TRAIL_KEEP_RATIO_TIGHT:-$(read_dotenv_value LIVE_INTRABAR_TRAIL_KEEP_RATIO_TIGHT)}"
LIVE_INTRABAR_TRAIL_ARM_BUFFER_RATIO_VAL="${LIVE_INTRABAR_TRAIL_ARM_BUFFER_RATIO:-$(read_dotenv_value LIVE_INTRABAR_TRAIL_ARM_BUFFER_RATIO)}"
LIVE_INTRABAR_TRAIL_CONFIRM_POLLS_VAL="${LIVE_INTRABAR_TRAIL_CONFIRM_POLLS:-$(read_dotenv_value LIVE_INTRABAR_TRAIL_CONFIRM_POLLS)}"
LIVE_INTRABAR_MIN_BAR_AGE_SEC_VAL="${LIVE_INTRABAR_MIN_BAR_AGE_SEC:-$(read_dotenv_value LIVE_INTRABAR_MIN_BAR_AGE_SEC)}"
LIVE_INTRABAR_DISABLE_LAST_SEC_VAL="${LIVE_INTRABAR_DISABLE_LAST_SEC:-$(read_dotenv_value LIVE_INTRABAR_DISABLE_LAST_SEC)}"
...
compose exec -T \
  ...
  -e LIVE_INTRABAR_TAKE_PROFIT_CHANGE_PCT="${LIVE_INTRABAR_TAKE_PROFIT_CHANGE_PCT_VAL:-}" \
  -e LIVE_INTRABAR_TAKE_PROFIT_PIPS="${LIVE_INTRABAR_TAKE_PROFIT_PIPS_VAL:-}" \
  -e LIVE_INTRABAR_TAKE_PROFIT_MONEY="${LIVE_INTRABAR_TAKE_PROFIT_MONEY_VAL:-}" \
  -e LIVE_INTRABAR_TRAILING_ENABLED="${LIVE_INTRABAR_TRAILING_ENABLED_VAL:-}" \
  -e LIVE_INTRABAR_TRAIL_KEEP_RATIO_TREND="${LIVE_INTRABAR_TRAIL_KEEP_RATIO_TREND_VAL:-}" \
  -e LIVE_INTRABAR_TRAIL_KEEP_RATIO_NORMAL="${LIVE_INTRABAR_TRAIL_KEEP_RATIO_NORMAL_VAL:-}" \
  -e LIVE_INTRABAR_TRAIL_KEEP_RATIO_TIGHT="${LIVE_INTRABAR_TRAIL_KEEP_RATIO_TIGHT_VAL:-}" \
  -e LIVE_INTRABAR_TRAIL_ARM_BUFFER_RATIO="${LIVE_INTRABAR_TRAIL_ARM_BUFFER_RATIO_VAL:-}" \
  -e LIVE_INTRABAR_TRAIL_CONFIRM_POLLS="${LIVE_INTRABAR_TRAIL_CONFIRM_POLLS_VAL:-}" \
  -e LIVE_INTRABAR_MIN_BAR_AGE_SEC="${LIVE_INTRABAR_MIN_BAR_AGE_SEC_VAL:-}" \
  -e LIVE_INTRABAR_DISABLE_LAST_SEC="${LIVE_INTRABAR_DISABLE_LAST_SEC_VAL:-}" \
